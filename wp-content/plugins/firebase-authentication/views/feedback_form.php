...
function mo_firebase_auth_display_feedback_form() {
	...
	$deactivate_reasons = array( "Does not have the features I'm looking for", "Confusing Interface",
		"Bugs in the plugin", "Unable to register", "Other Reasons" );
	wp_enqueue_style( 'wp-pointer' );
	wp_enqueue_script( 'wp-pointer' );
	wp_enqueue_script( 'utils' );
    wp_enqueue_style( 'mo_firebase_auth_admin_settings_style', plugin_dir_url( dirname(__FILE__) ) . 'admin/css/style.css');
