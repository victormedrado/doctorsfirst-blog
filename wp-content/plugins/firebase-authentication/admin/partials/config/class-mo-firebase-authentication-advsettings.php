...
class Mo_Firebase_Authentication_Admin_AdvSettings {
		...
		<div class="col-md-12">
			<div class="mo_firebase_auth_card" style="width:100%">
				<form name="integration_form" id="mo_firebase_auth_integration"  method="post" style="margin-bottom: 10px;">
					...
					<span style="float: right; font-size: 14px; margin-top: 10px;">[<a href="https://plugins.miniorange.com/firebase-woocommerce-integration" target="_blank" rel="noopener">Click here</a>]</span>
		...
		<div class="col-md-12">
			<div class="mo_firebase_auth_card" style="width:100%">
				<form name="integration_form" id="mo_firebase_auth_integration"  method="post" style="margin-bottom: 10px;">
					...
					<span style="float: right; font-size: 14px; margin-top: 10px;">[<a href="https://plugins.miniorange.com/firebase-social-login-integration-for-wordpress" target="_blank" rel="noopener">Click here</a>]</span>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="mo_firebase_auth_card" style="width:100%">
				<div style="display: inline-block;"><h3  style="margin: 10px 0;">Phone Authentication method support</h3></div>&nbsp;<small style="color: #FF0000"> <a href="admin.php?page=mo_firebase_authentication&tab=licensing_plans">[ENTERPRISE]</a></small>
				<p>
					Using the Firebase Phone authentication method, you can allow passwordless login into your site via One Time Passcodes(OTP) sent to the user's phone.
				</p>
			</div>
		</div>
	</div>
